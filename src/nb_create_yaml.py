...
print(f'Your public key is: {key.decode()}. It is saved in envrionment variables under the name: "KEVIN_SQL".')
...
yaml_list = [{'mysql_server': {'address': sql_address, 'port': str(sql_port), 'username': sql_uname, 'password_key': enc_passwd}},
              {'spoonacular_api_key': spoon_key}, {'telegram_bot_api_key': telegram_key}]

with open('nb.yaml', 'w') as fn:
